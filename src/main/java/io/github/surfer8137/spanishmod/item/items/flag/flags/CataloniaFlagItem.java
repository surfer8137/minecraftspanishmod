 ...
 */
public class CataloniaFlagItem extends FlagItem {
    public static final String NAME = "cataloniaflag";
    public static final String USE_MESSAGE = "VISCA LA INDEPENDENCIA";
    public static final String ITEM_TOOLTIP = "Catalonia flag";

    public CataloniaFlagItem() {
